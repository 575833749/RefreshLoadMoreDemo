...
//            final int top=bottom-1;
            mDivider.setColorFilter(0xffe8e8e8, PorterDuff.Mode.SRC);
            mDivider.setBounds(left, top, right, bottom);
//            mDivider.setBounds(left+ UnitUtils.dip2px(mContext,10), top, right- UnitUtils.dip2px(mContext,10), bottom);
            mDivider.draw(c);
        }
    }
