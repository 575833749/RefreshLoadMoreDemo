...
public class PullToRefreshLayout extends RelativeLayout {
	...
	// 释放刷新
	public  final int RELEASE_TO_REFRESH = 1;
	// 正在刷新
	public  final int REFRESHING = 2;
	// 释放加载
	public  final int RELEASE_TO_LOAD = 3;
	// 正在加载
...
//			refreshStateImageView.setVisibility(View.VISIBLE);
			refreshStateTextView.setText(R.string.refresh_done);
...
//			refreshStateImageView.setVisibility(View.VISIBLE);
			pullView.clearAnimation();
			refreshStateImageView.setVisibility(View.GONE);
			refreshStateTextView.setText(R.string.refresh_error);
//			refreshStateImageView
	...
	public void loadmoreFinish(int refreshResult) {
		...
		switch (refreshResult) {
			case NO_MORE_DATA:
				...
				refreshStateImageView.setVisibility(View.GONE);
				//			refreshStateImageView.setVisibility(View.VISIBLE);
				loadStateTextView.setText(R.string.no_more_data);
				break;
		case SUCCEED:
			// 加载成功
			loadStateImageView.setVisibility(View.GONE);
//			loadStateImageView.setVisibility(View.VISIBLE);
			loadStateTextView.setText(R.string.load_done);
//			loadStateImageView.setBackgroundResource(R.drawable.load_succeed);
		...
		default:
			...
			loadStateImageView.setVisibility(View.GONE);
//			loadStateImageView.setVisibility(View.VISIBLE);
			loadStateTextView.setText(R.string.load_error);
//			loadStateImageView.setBackgroundResource(R.drawable.load_failed);
	...
	private void changeState(int to) {
		...
		case INIT:
			// 下拉布局初始状态
			refreshStateImageView.setVisibility(View.GONE);
			refreshStateTextView.setText(R.string.listview_header_hint_normal);
			pullView.clearAnimation();
			pullView.setVisibility(View.VISIBLE);
			// 上拉布局初始状态
			loadStateImageView.setVisibility(View.GONE);
			loadStateTextView.setText(R.string.listview_foot_hint_load_normal);
			pullUpView.clearAnimation();
			pullUpView.setVisibility(View.VISIBLE);
			break;
		case RELEASE_TO_REFRESH:
			// 释放刷新状态
			refreshStateTextView.setText(R.string.listview_header_hint_release);
...
//			pullView.setVisibility(View.VISIBLE);
		...
		case RELEASE_TO_LOAD:
			// 释放加载状态
			loadStateTextView.setText(R.string.listview_foote_hint_load_release);
		...
		case LOADING:
			...
			loadStateTextView.setText(R.string.listview_loading);
			break;
		case DONE:
			// 刷新或加载完毕，啥都不做
			break;
	...
	private void initView() {
		...
		refreshingView.setImageResource(R.mipmap.default_ptr_rotate);
