...
//            mRefreshHeader.setProgressStyle(mRefreshProgressStyle);
    ...
    public void reset(){
        setIsNomore(false);
        loadMoreComplete(LoadingMoreFooter.STATE_COMPLETE);
        refreshComplete(BaseRefreshHeader.STATE_REFRESH_SUCCESS);
    }
    ...
    public void refreshComplete(int state) {
        isLoadingData=false;
        mRefreshHeader.refreshComplate(state);
    }
    ...
    public void onScrolled(int dx, int dy) {
        ...
        startLoadMoreData(dy);

    }

    public void startLoadMoreData(int dy) {
        if (isnomore){
            return;
        }
